...
import { getMyPage, type MyPageData } from "../api/mypage";
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-orange-50">
        <p className="text-red-500">
          {error || "마이페이지 정보를 찾을 수 없습니다."}
        </p>
      </main>
    );
  }

  const { user, stats } = myPage;
        ...
        <section className="rounded-3xl bg-white p-8 shadow-sm">
          ...
          <div className="mt-8 grid grid-cols-3 gap-3">
            <div className="rounded-2xl bg-orange-50 p-5 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">취미</p>
            </div>
            ...
            <div className="rounded-2xl bg-green-50 p-5 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">기록</p>
            </div>
            ...
            <div className="rounded-2xl bg-yellow-50 p-5 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">스탬프</p>
            </div>
          </div>
        </section>

        <section className="mt-6 rounded-3xl bg-white p-8 shadow-sm">
          <h2 className="text-xl font-bold text-gray-900">나의 활동</h2>

          <div className="mt-5 divide-y divide-gray-100">
            <div className="flex w-full items-center justify-between py-5 text-left">
              <div>
                <p className="font-semibold text-gray-900">📝 작성한 게시글</p>
              ...
              <span className="font-bold text-gray-600">{stats.postCount}</span>
            </div>

            <div className="flex w-full items-center justify-between py-5 text-left">
              <div>
                <p className="font-semibold text-gray-900">💬 작성한 댓글</p>

                <p className="mt-1 text-sm text-gray-500">내가 남긴 댓글</p>
              </div>
            ...
            <div className="flex w-full items-center justify-between py-5 text-left">
              <div>
                <p className="font-semibold text-gray-900">🏆 획득한 스탬프</p>
            ...
            <div className="flex w-full items-center justify-between py-5 text-left">
              <div>
                <p className="font-semibold text-gray-900">❤️ 관심 취미</p>

                <p className="mt-1 text-sm text-gray-500">활동 중인 취미</p>
              </div>
